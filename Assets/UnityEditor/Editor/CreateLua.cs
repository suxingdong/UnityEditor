...
public class CreateLuaScript
{
    ...
    public static void CreatNewLua()
    {
        ...
        null,
       "Assets/UnityEditor/Editor/Lua/Template/lua.lua");
    }
...
class MyDoCreateScriptAsset : EndNameEditAction
{
    ...
    internal static UnityEngine.Object CreateScriptAssetFromTemplate(string pathName, string resourceFile)
    {
        ...
        text = Regex.Replace(text, "#AUTHORNAME#", "East.Su");
        text = Regex.Replace(text, "#CREATETIME#", DateTime.Now.Date.ToString());
        text = Regex.Replace(text, "#VERSION#", Version);
